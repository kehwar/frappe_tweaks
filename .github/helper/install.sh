...
bench -v init frappe-bench --skip-assets --python "$(which python)" --frappe-path https://github.com/kehwar/frappe --frappe-branch custom
...
bench get-app https://github.com/kehwar/erpnext --branch custom
echo "::endgroup::"
